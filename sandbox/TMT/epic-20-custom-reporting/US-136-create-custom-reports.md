...
## Context
Create custom reports exists so stakeholders can understand quality status without assembling data manually. It belongs to the Custom Reporting backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete Create custom reports
**Given** a test lead is working inside the correct TMT project and is ready to create custom reports
**When** they create custom reports
...
**Given** required input, mappings, or permissions for create custom reports are missing
**When** the test lead tries to create custom reports
