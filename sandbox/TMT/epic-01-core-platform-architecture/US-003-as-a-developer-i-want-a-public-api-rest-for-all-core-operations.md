# User Story: As a developer, I want a public API (REST) for all core operations
...
**I want** As a developer, I want a public API (REST) for all core operations
**So that** API consumers can understand and adopt the platform contract more quickly

---

## Context
As a developer, I want a public API (REST) for all core operations exists so API consumers can understand and adopt the platform contract more quickly. It belongs to the Core Platform Architecture backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete As a developer, I want a public API (REST) for all core operations
**Given** a system administrator is working inside the correct TMT project and is ready to As a developer, I want a public API (REST) for all core operations
**When** they As a developer, I want a public API (REST) for all core operations
...
**Given** required input, mappings, or permissions for as a developer, I want a public API (REST) for all core operations are missing
**When** the system administrator tries to As a developer, I want a public API (REST) for all core operations
