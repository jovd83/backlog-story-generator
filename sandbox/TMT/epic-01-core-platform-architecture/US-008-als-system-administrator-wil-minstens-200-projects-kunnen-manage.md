# User Story: AlS System administrator wil minstens 200 projects kunnen manage
...
**I want** AlS System administrator wil minstens 200 projects kunnen manage
**So that** the platform foundation supports safe and scalable TMT delivery

---

## Context
AlS System administrator wil minstens 200 projects kunnen manage exists so the platform foundation supports safe and scalable TMT delivery. It belongs to the Core Platform Architecture backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete AlS System administrator wil minstens 200 projects kunnen manage
**Given** a system administrator is working inside the correct TMT project and is ready to AlS System administrator wil minstens 200 projects kunnen manage
**When** they AlS System administrator wil minstens 200 projects kunnen manage
...
**Given** required input, mappings, or permissions for alS System administrator wil minstens 200 projects kunnen manage are missing
**When** the system administrator tries to AlS System administrator wil minstens 200 projects kunnen manage
