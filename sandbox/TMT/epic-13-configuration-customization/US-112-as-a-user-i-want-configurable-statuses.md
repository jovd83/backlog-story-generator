# User Story: As a user, I want configurable statuses
...
**I want** As a user, I want configurable statuses
**So that** the platform foundation supports safe and scalable TMT delivery

---

## Context
As a user, I want configurable statuses exists so the platform foundation supports safe and scalable TMT delivery. It belongs to the Configuration Customization backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete As a user, I want configurable statuses
**Given** a system administrator is working inside the correct TMT project and is ready to As a user, I want configurable statuses
**When** they As a user, I want configurable statuses
...
**Given** required input, mappings, or permissions for as a user, I want configurable statuses are missing
**When** the system administrator tries to As a user, I want configurable statuses
