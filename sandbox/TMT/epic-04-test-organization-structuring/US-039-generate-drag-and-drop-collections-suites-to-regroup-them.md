# User Story: Generate Drag and Drop Collections Suites to Regroup Them
...
**As a** tester
**I want** to generate drag and drop collections suites to regroup them
**So that** teams can answer repository questions faster without manually searching across project artifacts

---

## Context
This story adds the ability for tester to generate drag and drop collections suites to regroup them in the Test Organization Structuring epic. Today, the capability is not yet a dedicated project-scoped workflow. With this change, tester can generate drag and drop collections suites to regroup them inside the current project boundary, and teams can answer repository questions faster without manually searching across project artifacts. It sits with the other Test Organization Structuring stories that use project knowledge to accelerate analysis and Across the product, it supports faster analysis while staying grounded in project knowledge
...
### Scenario 1: Valid project-scoped Generate Drag and Drop Collections Suites to Regroup Them
**Given** a tester is working in a TMT project with the required repository-grounded AI answers context
**When** they generate drag and drop collections suites to regroup them using valid project data
...
**When** they attempt to generate drag and drop collections suites to regroup them
