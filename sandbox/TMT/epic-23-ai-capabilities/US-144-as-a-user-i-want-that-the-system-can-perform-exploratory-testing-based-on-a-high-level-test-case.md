# User Story: As a user i want that the system can perform exploratory testing based on a high level test case
...
**As a** tester
**I want** As a user i want that the system can perform exploratory testing based on a high level test case
**So that** teams can move faster while still grounding decisions in project evidence

---

## Context
As a user i want that the system can perform exploratory testing based on a high level test case exists so teams can move faster while still grounding decisions in project evidence. It belongs to the AI Capabilities backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete As a user i want that the system can perform exploratory testing based on a high level test case
**Given** a tester is working inside the correct TMT project and is ready to As a user i want that the system can perform exploratory testing based on a high level test case
**When** they As a user i want that the system can perform exploratory testing based on a high level test case
...
**Given** required input, mappings, or permissions for as a user i want that the system can perform exploratory testing based on a high level test case are missing
**When** the tester tries to As a user i want that the system can perform exploratory testing based on a high level test case
