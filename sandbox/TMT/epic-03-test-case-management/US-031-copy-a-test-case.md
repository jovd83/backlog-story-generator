...
**As a** tester
**I want** to copy a test case
**So that** teams can reuse proven setup faster instead of recreating the same assets from scratch

---

## Context
This story adds the ability for tester to copy a test case in the Test Case Management epic. Today, users still need to rebuild or duplicate this work by hand. With this change, tester can copy a test case inside the current project boundary, and teams can reuse proven setup faster instead of recreating the same assets from scratch. It sits with the other Test Case Management stories that let teams duplicate or reuse existing work and Across the product, it reduces duplicate effort and keeps setup consistent

---

## Functional / Business References
- C:/projects/VS_prj/TMT_codex/starting_point/starting_point_func.md: normalized TMT backlog source for US-031 (Test Case Management)
- C:/projects/VS_prj/TMT_codex/starting_point/starting_point_tech.md: architecture, deployment, and quality constraints for TMT implementation

## Acceptance Criteria

### Scenario 1: Valid project-scoped Copy a Test Case
**Given** a tester is working in a TMT project with the required a test case context
**When** they copy a test case using valid project data
**Then** the duplicated or reusable a test case is created from the selected source

### Scenario 2: Invalid input or insufficient permission
**Given** the a test case request is missing required data or the user lacks the needed permission
**When** they attempt to copy a test case
