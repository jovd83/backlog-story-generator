# User Story: Attach files, images, and links
...
**As a** tester
**I want** to attach files, images, and links
**So that** test assets stay maintainable and trustworthy as coverage evolves

---

## Context
Attach files, images, and links exists so test assets stay maintainable and trustworthy as coverage evolves. It belongs to the Test Case Management backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete Attach files, images, and links
**Given** a tester is working inside the correct TMT project and is ready to attach files, images, and links
**When** they attach files, images, and links
...
**Given** required input, mappings, or permissions for attach files, images, and links are missing
**When** the tester tries to attach files, images, and links
