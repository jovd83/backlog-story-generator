# User Story: As a user I want to see a list of all requirements for a project
...
**As a** tester
**I want** As a user I want to see a list of all requirements for a project
**So that** release and coverage decisions can rely on current execution evidence

---

## Context
As a user I want to see a list of all requirements for a project exists so release and coverage decisions can rely on current execution evidence. It belongs to the Requirements and Traceability backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete As a user I want to see a list of all requirements for a project
**Given** a tester is working inside the correct TMT project and is ready to As a user I want to see a list of all requirements for a project
**When** they As a user I want to see a list of all requirements for a project
...
**Given** required input, mappings, or permissions for as a user I want to see a list of all requirements for a project are missing
**When** the tester tries to As a user I want to see a list of all requirements for a project
