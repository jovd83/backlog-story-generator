# User Story: As a user, I want in a jira ticket a table with all linked test cases and their latest results
...
**As a** tester
**I want** As a user, I want in a jira ticket a table with all linked test cases and their latest results
**So that** release and coverage decisions can rely on current execution evidence

---

## Context
As a user, I want in a jira ticket a table with all linked test cases and their latest results exists so release and coverage decisions can rely on current execution evidence. It belongs to the Requirements and Traceability backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete As a user, I want in a jira ticket a table with all linked test cases and their latest results
**Given** a tester is working inside the correct TMT project and is ready to As a user, I want in a jira ticket a table with all linked test cases and their latest results
**When** they As a user, I want in a jira ticket a table with all linked test cases and their latest results
...
**Given** required input, mappings, or permissions for as a user, I want in a jira ticket a table with all linked test cases and their latest results are missing
**When** the tester tries to As a user, I want in a jira ticket a table with all linked test cases and their latest results
