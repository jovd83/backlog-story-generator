# User Story: See a table with all linked test cases to a requirement, with their latest results
...
**As a** tester
**I want** to see a table with all linked test cases to a requirement, with their latest results
**So that** release and coverage decisions can rely on current execution evidence

---

## Context
See a table with all linked test cases to a requirement, with their latest results exists so release and coverage decisions can rely on current execution evidence. It belongs to the Requirements and Traceability backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete See a table with all linked test cases to a requirement, with their latest results
**Given** a tester is working inside the correct TMT project and is ready to see a table with all linked test cases to a requirement, with their latest results
**When** they see a table with all linked test cases to a requirement, with their latest results
...
**Given** required input, mappings, or permissions for see a table with all linked test cases to a requirement, with their latest results are missing
**When** the tester tries to see a table with all linked test cases to a requirement, with their latest results
