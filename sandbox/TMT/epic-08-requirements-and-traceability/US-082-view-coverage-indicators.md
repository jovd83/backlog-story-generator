# User Story: View Coverage Indicators
...
**As a** tester
**I want** to view coverage indicators
**So that** teams can answer repository questions faster without manually searching across project artifacts

---

## Context
This story adds the ability for tester to view coverage indicators in the Requirements and Traceability epic. Today, the needed information is still spread across separate records, so teams have to assemble it manually before they can act. With this change, tester can view coverage indicators inside the current project boundary, and teams can answer repository questions faster without manually searching across project artifacts. It sits with the other Requirements and Traceability stories that use project knowledge to accelerate analysis and Across the product, it supports faster analysis while staying grounded in project knowledge
...
### Scenario 1: Valid project-scoped View Coverage Indicators
**Given** a tester is working in a TMT project with the required repository-grounded AI answers context
**When** they view coverage indicators using valid project data
...
**When** they attempt to view coverage indicators
