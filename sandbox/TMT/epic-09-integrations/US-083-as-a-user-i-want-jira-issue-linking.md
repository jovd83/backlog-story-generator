# User Story: As a user, I want Jira issue linking
...
**As a** integrator
**I want** As a user, I want Jira issue linking
**So that** teams can exchange or publish test information without losing control of the data

---

## Context
As a user, I want Jira issue linking exists so teams can exchange or publish test information without losing control of the data. It belongs to the Integrations backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete As a user, I want Jira issue linking
**Given** a integrator is working inside the correct TMT project and is ready to As a user, I want Jira issue linking
**When** they As a user, I want Jira issue linking
...
**Given** required input, mappings, or permissions for as a user, I want Jira issue linking are missing
**When** the integrator tries to As a user, I want Jira issue linking
