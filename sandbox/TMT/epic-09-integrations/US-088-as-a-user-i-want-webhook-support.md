# User Story: As a user, I want webhook support
...
**As a** integrator
**I want** As a user, I want webhook support
**So that** teams can exchange or publish test information without losing control of the data

---

## Context
As a user, I want webhook support exists so teams can exchange or publish test information without losing control of the data. It belongs to the Integrations backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete As a user, I want webhook support
**Given** a integrator is working inside the correct TMT project and is ready to As a user, I want webhook support
**When** they As a user, I want webhook support
...
**Given** required input, mappings, or permissions for as a user, I want webhook support are missing
**When** the integrator tries to As a user, I want webhook support
