...
**As a** tester
**I want** to be able to delete old test case executions per test cycle
**So that** release and coverage decisions can rely on current execution evidence

---

## Context
Delete old test case executions per test cycle exists so release and coverage decisions can rely on current execution evidence. It belongs to the Automated Test Execution backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete Delete old test case executions per test cycle
**Given** a tester is working inside the correct TMT project and is ready to be able to delete old test case executions per test cycle
**When** they be able to delete old test case executions per test cycle
...
**Given** required input, mappings, or permissions for delete old test case executions per test cycle are missing
**When** the tester tries to be able to delete old test case executions per test cycle
