# User Story: As a user, I want CI pipelines to push results automatically, from: Jenkins GitLab CI
...
**As a** tester
**I want** As a user, I want CI pipelines to push results automatically, from: Jenkins GitLab CI
**So that** release and coverage decisions can rely on current execution evidence

---

## Context
As a user, I want CI pipelines to push results automatically, from: Jenkins GitLab CI exists so release and coverage decisions can rely on current execution evidence. It belongs to the Automated Test Execution backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete As a user, I want CI pipelines to push results automatically, from: Jenkins GitLab CI
**Given** a tester is working inside the correct TMT project and is ready to As a user, I want CI pipelines to push results automatically, from: Jenkins GitLab CI
**When** they As a user, I want CI pipelines to push results automatically, from: Jenkins GitLab CI
...
**Given** required input, mappings, or permissions for as a user, I want CI pipelines to push results automatically, from: Jenkins GitLab CI are missing
**When** the tester tries to As a user, I want CI pipelines to push results automatically, from: Jenkins GitLab CI
