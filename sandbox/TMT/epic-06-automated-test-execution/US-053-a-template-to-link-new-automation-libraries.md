# User Story: A template to link new automation libraries
...
**I want** to have a template to link new automation libraries
**So that** release and coverage decisions can rely on current execution evidence

---

## Context
A template to link new automation libraries exists so release and coverage decisions can rely on current execution evidence. It belongs to the Automated Test Execution backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete A template to link new automation libraries
**Given** a system i want to send screenshots to the system, generated by frontend automation libraries user is working inside the correct TMT project and is ready to have a template to link new automation libraries
**When** they have a template to link new automation libraries
...
**Given** required input, mappings, or permissions for a template to link new automation libraries are missing
**When** the system i want to send screenshots to the system, generated by frontend automation libraries user tries to have a template to link new automation libraries
