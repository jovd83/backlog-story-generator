# User Story: See automation history per test
...
**As a** tester
**I want** to see automation history per test
**So that** release and coverage decisions can rely on current execution evidence

---

## Context
See automation history per test exists so release and coverage decisions can rely on current execution evidence. It belongs to the Automated Test Execution backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete See automation history per test
**Given** a tester is working inside the correct TMT project and is ready to see automation history per test
**When** they see automation history per test
...
**Given** required input, mappings, or permissions for see automation history per test are missing
**When** the tester tries to see automation history per test
