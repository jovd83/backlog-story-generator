# User Story: Archive or delete projects
...
## Context
Archive or delete projects exists so the platform foundation supports safe and scalable TMT delivery. It belongs to the Project Workspace Management backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete Archive or delete projects
**Given** a system administrator is working inside the correct TMT project and is ready to archive or delete projects
**When** they archive or delete projects
...
**Given** required input, mappings, or permissions for archive or delete projects are missing
**When** the system administrator tries to archive or delete projects
