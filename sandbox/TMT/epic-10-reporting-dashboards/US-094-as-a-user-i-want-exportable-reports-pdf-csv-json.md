# User Story: As a user, I want exportable reports (PDF, CSV, JSON)
...
**As a** test lead
**I want** As a user, I want exportable reports (PDF, CSV, JSON)
**So that** stakeholders can understand quality status without assembling data manually

---

## Context
As a user, I want exportable reports (PDF, CSV, JSON) exists so stakeholders can understand quality status without assembling data manually. It belongs to the Reporting Dashboards backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete As a user, I want exportable reports (PDF, CSV, JSON)
**Given** a test lead is working inside the correct TMT project and is ready to As a user, I want exportable reports (PDF, CSV, JSON)
**When** they As a user, I want exportable reports (PDF, CSV, JSON)
...
**Given** required input, mappings, or permissions for as a user, I want exportable reports (PDF, CSV, JSON) are missing
**When** the test lead tries to As a user, I want exportable reports (PDF, CSV, JSON)
