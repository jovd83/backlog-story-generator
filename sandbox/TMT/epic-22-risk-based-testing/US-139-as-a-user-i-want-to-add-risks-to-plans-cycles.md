# User Story: As a user I want to add risks to plans / cycles
...
**As a** tester
**I want** As a user I want to add risks to plans / cycles
**So that** release and coverage decisions can rely on current execution evidence

---

## Context
As a user I want to add risks to plans / cycles exists so release and coverage decisions can rely on current execution evidence. It belongs to the Risk Based Testing backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete As a user I want to add risks to plans / cycles
**Given** a tester is working inside the correct TMT project and is ready to As a user I want to add risks to plans / cycles
**When** they As a user I want to add risks to plans / cycles
...
**Given** required input, mappings, or permissions for as a user I want to add risks to plans / cycles are missing
**When** the tester tries to As a user I want to add risks to plans / cycles
