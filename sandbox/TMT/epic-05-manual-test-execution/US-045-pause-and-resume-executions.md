# User Story: Pause and resume executions
...
**As a** tester
**I want** to pause and resume executions
**So that** release and coverage decisions can rely on current execution evidence

---

## Context
Pause and resume executions exists so release and coverage decisions can rely on current execution evidence. It belongs to the Manual Test Execution backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete Pause and resume executions
**Given** a tester is working inside the correct TMT project and is ready to pause and resume executions
**When** they pause and resume executions
...
**Given** required input, mappings, or permissions for pause and resume executions are missing
**When** the tester tries to pause and resume executions
