# User Story: As a tester, I want exploratory test notes
...
**As a** tester
**I want** As a tester, I want exploratory test notes
**So that** release and coverage decisions can rely on current execution evidence

---

## Context
As a tester, I want exploratory test notes exists so release and coverage decisions can rely on current execution evidence. It belongs to the Manual Test Execution backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete As a tester, I want exploratory test notes
**Given** a tester is working inside the correct TMT project and is ready to As a tester, I want exploratory test notes
**When** they As a tester, I want exploratory test notes
...
**Given** required input, mappings, or permissions for as a tester, I want exploratory test notes are missing
**When** the tester tries to As a tester, I want exploratory test notes
