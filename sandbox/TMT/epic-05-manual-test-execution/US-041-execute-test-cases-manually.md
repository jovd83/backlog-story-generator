# User Story: Execute test cases manually
...
**As a** tester
**I want** to execute test cases manually
**So that** release and coverage decisions can rely on current execution evidence

---

## Context
Execute test cases manually exists so release and coverage decisions can rely on current execution evidence. It belongs to the Manual Test Execution backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete Execute test cases manually
**Given** a tester is working inside the correct TMT project and is ready to execute test cases manually
**When** they execute test cases manually
...
**Given** required input, mappings, or permissions for execute test cases manually are missing
**When** the tester tries to execute test cases manually
