# User Story: As a user, I want multiple test cycles per test plan
...
**As a** tester
**I want** As a user, I want multiple test cycles per test plan
**So that** release and coverage decisions can rely on current execution evidence

---

## Context
As a user, I want multiple test cycles per test plan exists so release and coverage decisions can rely on current execution evidence. It belongs to the Test Cycles and Plans backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete As a user, I want multiple test cycles per test plan
**Given** a tester is working inside the correct TMT project and is ready to As a user, I want multiple test cycles per test plan
**When** they As a user, I want multiple test cycles per test plan
...
**Given** required input, mappings, or permissions for as a user, I want multiple test cycles per test plan are missing
**When** the tester tries to As a user, I want multiple test cycles per test plan
