# User Story: See progress of a test cycle
...
**As a** tester
**I want** to see progress of a test cycle
**So that** release and coverage decisions can rely on current execution evidence

---

## Context
See progress of a test cycle exists so release and coverage decisions can rely on current execution evidence. It belongs to the Test Cycles and Plans backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete See progress of a test cycle
**Given** a tester is working inside the correct TMT project and is ready to see progress of a test cycle
**When** they see progress of a test cycle
...
**Given** required input, mappings, or permissions for see progress of a test cycle are missing
**When** the tester tries to see progress of a test cycle
