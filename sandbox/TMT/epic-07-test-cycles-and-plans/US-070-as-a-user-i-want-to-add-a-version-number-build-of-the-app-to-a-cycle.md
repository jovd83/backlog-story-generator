# User Story: As a User I want to add a version number / build of the app to a cycle
...
**As a** tester
**I want** As a User I want to add a version number / build of the app to a cycle
**So that** release and coverage decisions can rely on current execution evidence

---

## Context
As a User I want to add a version number / build of the app to a cycle exists so release and coverage decisions can rely on current execution evidence. It belongs to the Test Cycles and Plans backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete As a User I want to add a version number / build of the app to a cycle
**Given** a tester is working inside the correct TMT project and is ready to As a User I want to add a version number / build of the app to a cycle
**When** they As a User I want to add a version number / build of the app to a cycle
...
**Given** required input, mappings, or permissions for as a User I want to add a version number / build of the app to a cycle are missing
**When** the tester tries to As a User I want to add a version number / build of the app to a cycle
