...
## Context
Assign test cases to cycles exists so release and coverage decisions can rely on current execution evidence. It belongs to the Test Cycles and Plans backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete Assign test cases to cycles
**Given** a tester is working inside the correct TMT project and is ready to assign test cases to cycles
**When** they assign test cases to cycles
...
**Given** required input, mappings, or permissions for assign test cases to cycles are missing
**When** the tester tries to assign test cases to cycles
