# User Story: As a user, I want execution status per cycle
...
**As a** tester
**I want** As a user, I want execution status per cycle
**So that** release and coverage decisions can rely on current execution evidence

---

## Context
As a user, I want execution status per cycle exists so release and coverage decisions can rely on current execution evidence. It belongs to the Test Cycles and Plans backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete As a user, I want execution status per cycle
**Given** a tester is working inside the correct TMT project and is ready to As a user, I want execution status per cycle
**When** they As a user, I want execution status per cycle
...
**Given** required input, mappings, or permissions for as a user, I want execution status per cycle are missing
**When** the tester tries to As a user, I want execution status per cycle
