# User Story: As a user, I want data export of any given test suite/collections (with options) in csv/json/xml/html/word
...
### Scenario 1: Complete As a user, I want data export of any given test suite/collections (with options) in csv/json/xml/html/word
**Given** a integrator is working inside the correct TMT project and is ready to As a user, I want data export of any given test suite/collections (with options) in csv/json/xml/html/word
**When** they As a user, I want data export of any given test suite/collections (with options) in csv/json/xml/html/word
...
**Given** required input, mappings, or permissions for as a user, I want data export of any given test suite/collections (with options) in csv/json/xml/html/word are missing
**When** the integrator tries to As a user, I want data export of any given test suite/collections (with options) in csv/json/xml/html/word
