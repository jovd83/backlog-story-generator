# User Story: As a system administrator I want to export multiple projects at once
...
**As a** integrator
**I want** As a system administrator I want to export multiple projects at once
**So that** teams can exchange or publish test information without losing control of the data

---

## Context
As a system administrator I want to export multiple projects at once exists so teams can exchange or publish test information without losing control of the data. It belongs to the Import Export Migration backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete As a system administrator I want to export multiple projects at once
**Given** a integrator is working inside the correct TMT project and is ready to As a system administrator I want to export multiple projects at once
**When** they As a system administrator I want to export multiple projects at once
...
**Given** required input, mappings, or permissions for as a system administrator I want to export multiple projects at once are missing
**When** the integrator tries to As a system administrator I want to export multiple projects at once
