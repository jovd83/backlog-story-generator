# User Story: As a user, I want dry-run import validation
...
**As a** integrator
**I want** As a user, I want dry-run import validation
**So that** teams can exchange or publish test information without losing control of the data

---

## Context
As a user, I want dry-run import validation exists so teams can exchange or publish test information without losing control of the data. It belongs to the Import Export Migration backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete As a user, I want dry-run import validation
**Given** a integrator is working inside the correct TMT project and is ready to As a user, I want dry-run import validation
**When** they As a user, I want dry-run import validation
...
**Given** required input, mappings, or permissions for as a user, I want dry-run import validation are missing
**When** the integrator tries to As a user, I want dry-run import validation
