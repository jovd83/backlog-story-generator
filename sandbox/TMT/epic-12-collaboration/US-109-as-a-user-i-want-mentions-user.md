# User Story: As a user, I want mentions (@user)
...
**As a** test lead
**I want** As a user, I want mentions (@user)
**So that** stakeholders can understand quality status without assembling data manually

---

## Context
As a user, I want mentions (@user) exists so stakeholders can understand quality status without assembling data manually. It belongs to the Collaboration backlog and should keep project scope, traceability, and operability clear while TMT grows.
...
### Scenario 1: Complete As a user, I want mentions (@user)
**Given** a test lead is working inside the correct TMT project and is ready to As a user, I want mentions (@user)
**When** they As a user, I want mentions (@user)
...
**Given** required input, mappings, or permissions for as a user, I want mentions (@user) are missing
**When** the test lead tries to As a user, I want mentions (@user)
